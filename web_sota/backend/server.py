...
app.add_middleware(CORSMiddleware,allow_origins=["http://localhost:11118","http://127.0.0.1:11118","http://localhost:11119","http://127.0.0.1:11119","http://localhost:10892","http://127.0.0.1:10892","http://tauri.localhost","https://tauri.localhost","tauri://localhost"],allow_origin_regex=r"https?://(?:[a-zA-Z0-9-]+\.ts\.net|.*?\.tail-[a-f0-9]+\.ts\.net|tauri\.localhost|localhost|127\.0\.0\.1|192\.168\.\d{1,3}\.\d{1,3}|10\.\d{1,3}\.\d{1,3}\.\d{1,3}|100\.\d{1,3}\.\d{1,3}\.\d{1,3})(?::\d+)?$|^tauri://localhost$",allow_credentials=True,allow_methods=["*"],allow_headers=["*"])
@app.get("/health")
@app.get("/api/health")
